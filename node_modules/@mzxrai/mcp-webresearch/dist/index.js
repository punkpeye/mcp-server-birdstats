    ...
    try {
        ...
        const pageContent = await Promise.race([
            page.evaluate(() => {
                ...
                const hasBotProtection = botProtectionSelectors.some(selector => document.querySelector(selector) !== null);
            ...
            new Promise((_, reject) => setTimeout(() => reject(new Error('Content validation check timed out')), CONTENT_CHECK_TIMEOUT))
        ]);
